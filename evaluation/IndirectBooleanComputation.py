...
def predict(chain, dataObject):
    ...
    for item in dataObject['Assignment'].items():
        assignment_str += item[0] + '=' + str(item[1]) + ','

    assignment_str = assignment_str[:-1]
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Indirect Boolean Computation")
    # prompt args
    ...
    args.problem = 'IndirectBooleanComputation'
